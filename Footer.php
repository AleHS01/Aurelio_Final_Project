    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="footer-info">
          ...
          <p>
            ...
            <strong>Email:</strong> Ford@gmail.com<br>
          </p>
      ...
      <div class="col-lg-2 col-md-3 footer-links">
        ...
        <ul>
          ...
          <li><a href="#">Nuevos medio de transporte</a></li>
...
<div class="footer-legal text-center position-relative">
  <div class="container">
    <div class="copyright">
      &copy; Copyright <strong><span>2023 Ford Motor Company</span></strong>. All Rights Reserved
    </div>
  </div>
</div>
